...
#define GPIO_MODE_AF			2		//Alternate functions
#define GPIO_MODE_AN			3		//Analog
#define GPIO_MODE_ITRT			4		//Interrupt Rising Edge
#define GPIO_MODE_ITFT			5		//Interrupt Falling Edge
#define GPIO_MODE_ITRFT			6		//Interrupt Rising/Falling Edge
...
//GPIO_PUPDR
#define GPIO_PUPD_NPUPD			0	//No pull-up
